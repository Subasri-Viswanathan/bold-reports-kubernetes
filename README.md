...
[How to deploy Bold BI in Elastic Kubernetes Services (EKS) using Application Load Balancer (ALB)?](https://github.com/boldreports/bold-reports-kubernetes/blob/main//docs/FAQ/how-to-deploy-bold-reports-in-eks-using-application-load-balancer.md)
