...
[How to auto deploy Bold Reports in Kubernetes cluster?](https://github.com/boldreports/bold-reports-kubernetes/blob/main/docs/bold-bi-auto-deployment.md)

[How to deploy Bold BI in Elastic Kubernetes Services (EKS) using Application Load Balancer (ALB)?](https://github.com/boldreports/bold-reportsi-kubernetes/blob/main//docs/FAQ/how-to-deploy-bold-bi-in-eks-using-application-load-balancer.md)
